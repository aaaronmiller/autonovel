...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE]{\small\textsc{untitled novel}}
...
\newcommand{\makeepigraph}{%
  ...
  \begin{center}
  \itshape
  Optional epigraph goes here.\\
  Replace or remove this page\\
  for the current manuscript.\\[12pt]
  \end{center}
  \end{minipage}
  \end{center}
  \clearpage
...
{\small\texttt{https://example.com}}\\[16pt]

\IfFileExists{../art/qr_code.png}{%
  \includegraphics[width=1in]{../art/qr_code.png}
}{}
